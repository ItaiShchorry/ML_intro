...
def main(args):
    ...
    acs = []
    for eta in etas:
        accuracy = accuracyCalc(eta, C, T, validation_data, validation_labels)
        acs.append(accuracy)
    ...
    img_save = output + 'Q6_Section_A_eta'
    ...
    img_save = output + 'Q6_Section_A_C'
    plt.savefig(img_save)
    ...
    for j in K:
        ...
        plt.title(name)
        img_save = output + 'Q6_Section_B_weight_vector_for_digit_' + str(j)
        plt.savefig(img_save)
